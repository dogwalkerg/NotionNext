...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '952a12500bb54a1ebcf3854e64796ef6',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '莱特宁亮化工程', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚MRGU', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.ipone.ga', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'MRGU,莱特宁,Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'lxiaoya1003@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https:/blog.ipone.ga/', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://github.com/', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://t.me/', // 你的linkedIn 首页
  ...
  // 静态彩带特效
  RIBBON: process.env.NEXT_PUBLIC_RIBBON || true, // 开true,关false
